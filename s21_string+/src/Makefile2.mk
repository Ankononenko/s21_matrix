...
all: run_test gcov_report s21_string.a
...
s21_string.a: $(OBJECT_FILES_IN_BUILD_DIRECTORIES)
...
clean: 
		rm -rf $(BUILD_DIRECTORY) $(DEPENDENCY_DIRECTORY) $(OBJECT_DIRECTORIES_TO_CLEAN) $(TEST_FILE_GENERATED) *.gcov *.html *.css $(REPORT_DIRECTORY) $(STATIC_LIBRARY)
